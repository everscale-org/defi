...
class FakeDepool(object):
    def __init__(self, tonClient: TonClient, signer: Signer=None):
        ...
        self.ABI         = "../bin/FakeDepool.abi.json"
        self.TVC         = "../bin/FakeDepool.tvc"
        self.CONSTRUCTOR = {}
        self.INITDATA    = {}
    ...
    #========================================
    #
    def fakeMint(self, msig: SetcodeMultisig, value: int):
        result = self._callFromMultisig(msig=msig, functionName="fakeMint", functionParams={}, value=value, flags=1)
        return result
